...
<div class="flex-container">
  <div class="flex-item-left">View Sheathing Details <i class='fa fa-align-justify'></i></div>
</div>

<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>View Sheathing Details</title>
<style>
h3
{
	color: yellow;
...
<body>
<form action="tviewSeatingArrangementStudents.jsp" method="post">
<div class="left-div">
 <h3>Enter Date</h3>
 <input class="input-style" type="date" placeholder="dd-mm-yyyy" name="scheduleDate" placeholder="Enter Name" required>
</div>
<div class="right-div">
 <button class="button">Find <i class='far fa-arrow-alt-circle-right'></i></button>
 </div>
</form>
</body>
<br><br><br>
