...
<%
String scheduleDate=session.getAttribute("scheduleDate").toString();
...
<div class="flex-container">
  <div class="flex-item-left"><a href="viewSeatingArrangement.jsp">View Seating Arrangement</a> <i class="fas fa-angle-right"></i> <a href="">All Teachers</a> <i class="fas fa-angle-right"></i> All Students</div>
</div>
